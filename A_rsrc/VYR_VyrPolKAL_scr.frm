TYPE(drgForm) DTYPE(10) TITLE(Vyrábìné položky - PLÁNOVÁ kalkulace) FILE(VYRPOL);
...
TYPE(Action) CAPTION(~Kalkulace PLÁN) EVENT(VYR_KALKUL_SCR)  TIPTEXT(Plánová kalkulace )
...
TYPE(Action) ATYPE(5)
TYPE(Action) ATYPE(5)
TYPE(Action) CAPTION(~Kaklulace pl_ex)  EVENT(kalkHRcmp_ex)    TIPTEXT(Výpoèet hromadné kalkulace_ex)
*
...
** Plánovana kalkulace kalkul
  TYPE(TabPage) TTYPE(4) CAPTION(Kalkulace plán) FPOS(1,16.2) SIZE( 108, 8.5) RESIZE(yx) OFFSET(17,68) PRE( tabSelect)
