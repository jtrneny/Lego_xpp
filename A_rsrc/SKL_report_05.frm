TYPE(drgForm) DTYPE(10) TITLE();
  ...
  TYPE(Static) STYPE(12) SIZE(64.8, 11.8) FPOS( 0.1, 0.1) RESIZE(yx)
    ...
    TYPE(GET)  NAME(m->cStred_Od)      FPOS( 15, 4) FLEN( 18) FCAPTION( Støedisko Od)   CPOS( 2, 4 ) PUSH(NAZPOLn_sel)
    TYPE(GET)  NAME(m->cStred_Do)      FPOS( 40, 4) FLEN( 18) FCAPTION( Do)             CPOS(36, 4 ) PUSH(NAZPOLn_sel)
    TYPE(GET)  NAME(m->cStroj_Od)      FPOS( 15, 5) FLEN( 18) FCAPTION( Stroj  Od)      CPOS( 2, 5 ) PUSH(NAZPOLn_sel)
    TYPE(GET)  NAME(m->cStroj_Do)      FPOS( 40, 5) FLEN( 18) FCAPTION( Do)             CPOS(36, 5 ) PUSH(NAZPOLn_sel)
    TYPE(GET)  NAME(m->cVykon_Od)      FPOS( 15, 6) FLEN( 18) FCAPTION( Výkon Od)       CPOS( 2, 6 ) PUSH(NAZPOLn_sel)
    TYPE(GET)  NAME(m->cVykon_Do)      FPOS( 40, 6) FLEN( 18) FCAPTION( Do)             CPOS(36, 6 ) PUSH(NAZPOLn_sel)
    TYPE(GET)  NAME(m->cSklPol_Od)     FPOS( 15, 7) FLEN( 18) FCAPTION( Skl.položka Od) CPOS( 2, 7 ) PUSH(CENZBOZ_sel)
    TYPE(GET)  NAME(m->cSklPol_Do)     FPOS( 40, 7) FLEN( 18) FCAPTION( Do)             CPOS(36, 7 ) PUSH(CENZBOZ_sel)
