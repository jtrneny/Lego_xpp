TYPE(drgForm) DTYPE(10) TITLE(Bakovky a mince dané mìny ...) SIZE(115,20)       ;
                                                             POST(postValidate) ;
                                                             GUILOOK(Action:n) 

  TYPE(DBrowse) FPOS(0,.2) SIZE(51,19.5) FILE(C_MENY)                     ;
                                         FIELDS(cZKRATMENY:zkrMìny      , ;
                                                cNAZMENY:název mìny:30  , ;
                                                nMNOZPREP:pøepoèet      ) ;
  ...
  TYPE(EBrowse) FPOS(52,.2) SIZE(61,19.5) FILE(c_mince)                              ;
    ...
    TYPE(GET)      NAME(c_mince->cNazMince)  FLEN(30) CAPTION(název mince)         
