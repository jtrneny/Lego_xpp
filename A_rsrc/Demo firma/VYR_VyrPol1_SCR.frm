TYPE(drgForm) DTYPE(10) TITLE(Vyrábìné položky - test) FILE(VYRPOL);
...
TYPE(Action) ATYPE(5)
TYPE(Action) ATYPE(5)
TYPE(Action) CAPTION(~wKalkuk_Test)   EVENT(w_kalkul_Test)     TIPTEXT(Kalkul test rychlosti generování tree)
