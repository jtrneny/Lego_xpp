TYPE(drgForm) DTYPE(10) TITLE(Pøehled pohybù akcií dle akcionáøù ...) FILE(AKCIONAR)         ;
                                                                      SIZE(107,25)           ;
...
* APOHYBAK - pohyby / zmìny akcií
  TYPE(TabPage) CAPTION( akcie) FPOS(0, 14.2) SIZE(107,10.5) RESIZE(yx) TTYPE(3) OFFSET(1,81)
