TYPE(drgForm) DTYPE(10) TITLE();
  ...
  TYPE(Static) STYPE(12) SIZE(64.8, 11.8) FPOS( 0.1, 0.1) RESIZE(yx)
    ...
    TYPE(GET)  NAME(m->cStaj_Od)       FPOS( 15, 5) FLEN( 18) FCAPTION( Stáj  Od)       CPOS( 2, 5 ) PUSH(NAZPOLn_sel)
    TYPE(GET)  NAME(m->cStaj_Do)       FPOS( 40, 5) FLEN( 18) FCAPTION( Do)             CPOS(36, 5 ) PUSH(NAZPOLn_sel)
