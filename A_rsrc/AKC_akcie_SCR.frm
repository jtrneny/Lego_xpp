TYPE(drgForm) DTYPE(10) TITLE(Pøehled akcionáøù/ akcií ...) FILE(AKCIEsw)          ;
                                                            SIZE(107,25)           ;
                                                            CARGO(AKC_akcie_IN)    ;
...
* APOHYBAK - pohyby / zmìny akcií
  TYPE(TabPage) CAPTION(pohybAkcie) FPOS(0, 14.2) SIZE(107,10.5) RESIZE(yx) TTYPE(3) OFFSET(36,44)
...
*** QUICK FILTR ***
 TYPE(STATIC) STYPE(2) FPOS(0.50,-0.25) SIZE(106.75,1.25) RESIZE(yn)
   TYPE(TEXT) CAPTION(Akcie)     CPOS(1.5, 0.6) FONT(5)  CLEN(30)
*
