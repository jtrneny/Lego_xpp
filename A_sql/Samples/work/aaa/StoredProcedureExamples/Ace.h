/*******************************************************************************
* Source File  : ace.h
* Copyright    : 1996-2000 Extended Systems, Inc.
...
#if defined( ASANLM ) || defined( ASANT ) || defined( NLM ) || defined( ADS_NT ) || defined( ADS_WIN9X ) || defined( STAND_ALONE_EXE )
   #define ENTRYPOINT
...
#define ADS_CURSOR                5
#define ADS_DICTIONARY_CONNECTION 6
#define ADS_DICTIONARY            7
...
typedef struct
   ...
   UNSIGNED32  ulFlushFrequency; /* local server */

   UNSIGNED32  ulKeepAliveTimeOut; /* When not using semaophore files. In milli-secs*/
   UNSIGNED8   ucDisplayUserNames; /* Display connections using user names. */
   ...
   UNSIGNED32  ulInternetKeepAlive; /* In Milli-secs */
...
UNSIGNED32 ENTRYPOINT AdsCreateTable( ADSHANDLE    hObj,
                                      UNSIGNED8    *pucName,
                                      UNSIGNED8    *pucAlias,
                                      UNSIGNED16   usTableType,
...
UNSIGNED32 ENTRYPOINT AdsDDClose( ADSHANDLE hDictionary );
...
UNSIGNED32 ENTRYPOINT AdsDDOpen( UNSIGNED8  *pucDictionaryPath,
                                 UNSIGNED8  *pucPassword,
                                 ADSHANDLE  *phDictionary );
...
UNSIGNED32 ENTRYPOINT AdsDDAddUser( ADSHANDLE    hDictionary,
...
UNSIGNED32 ENTRYPOINT AdsDDRemoveUser( ADSHANDLE    hDictionary,
                                       UNSIGNED8    *pucGroupName,
                                       UNSIGNED8    *pucUserName );
...
UNSIGNED32 ENTRYPOINT AdsDDRemoveTable( ADSHANDLE    hDictionary,
                                        UNSIGNED8    *pucTableName,
