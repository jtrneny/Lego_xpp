...
method SYS_forms_modi_CRD:getForm()
  ...
  DRGFORM INTO drgFC SIZE 92,22 DTYPE '10' TITLE 'Modifikace sestavy' ;
   ...
   DRGTABPAGE INTO drgFC CAPTION 'Sestava' SIZE 91,21.2 OFFSET 1,81 FPOS .2,.2 PRE 'tabSelect' TABHEIGHT 1 SUBTABS 'A2,A3'

    DRGSTATIC INTO drgFC STYPE 14 SIZE 88.8,10.5 FPOS 1,.2
      odrg:ctype := 2
      ...
      DRGCOMBOBOX forms->ntypzpr INTO drgFC FPOS 25,6.9 FLEN 61 ;
                              VALUES '0: 0 - stantartní zpracování       ,'       + ;
                                    ...
                                    '10:10 - soubìžné zpracování TMP funkce,'     + ;
                                    '11:11 - zachová øídící soubor z definice formuláre' PP 2
       odrg:isedit_inrev := .f.
    ...
    DRGTABPAGE INTO drgFC CAPTION 'Datový model' FPOS 1,12 SIZE 89,9 OFFSET 1,81 TABHEIGHT .8 RESIZE 'yx' SUB 'A2'
      DRGMLE FORMS->mDATA_LL INTO drgFC FPOS .01,.01 SIZE 89,8.3 PP 2
      odrg:ronly := rOnly
    DRGEnd INTO drgFC

*    DRGTABPAGE INTO drgFC CAPTION 'subTable' FPOS 1,12 SIZE 89,9 OFFSET 18,64 TABHEIGHT .8 RESIZE 'yx' SUB 'A3'
*      DRGMLE FORMS->mDATA_LL INTO drgFC FPOS .01,.01 SIZE 89,8.3 PP 2
*      odrg:ronly := rOnly
*    DRGEnd INTO drgFC

   DRGEnd INTO drgFC    // tabPage 1 - end


   DRGTABPAGE INTO drgFC CAPTION 'Metodika' SIZE 91,21.2 OFFSET 18,63 FPOS .2,.2 PRE 'tabSelect' TABHEIGHT 1
     DRGMLE forms->mMetodika INTO drgFC FPOS 0.8,0.2 SIZE 89.0,19.3 POST 'postLastField'
     odrg:ronly := rOnly
   DRGEND INTO drgFC    // tabPage 4 - end

  DRGEnd INTO drgFC     // Fc        - end
