...
*
*****************************************************************
CLASS SYS_broColumn FROM drgUsrClass
EXPORTED:
...
method SYS_broColumn:init(parent)
...
method SYS_broColumn:drgDialogStart(drgDialog)
...
static function sys_broColumn_font( oPs, aInfo, self )
return .t.

*
**
static function sys_broColumn_colorBlock( m_deBrowse )
  local oBro   := m_deBrowse:oxbp, ocolumn
  local ncolor
  local acolor := { , , ,  }
...
method SYS_broColumn:getForm()
  local drgFC := drgFormContainer():new()

  DRGFORM INTO drgFC SIZE 110,18 DTYPE '10' TITLE 'Uživatelské nastavení sloupcù pohledu ...' ;
