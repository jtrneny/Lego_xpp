...
//-----+ FI_fakprihd_SCR +-------------------------------------------------------
CLASS MZD_uctsastr_SCR FROM drgUsrClass
EXPORTED:
...
*********************************************************************
METHOD MZD_uctsastr_SCR:Init(parent)
...
METHOD MZD_uctsastr_SCR:InFocus(oB)
 ::drgDialog:DialogCtrl:oBrowse := oB:cargo
RETURN .T.

**
METHOD MZD_uctsastr_SCR:drgDialogStart(drgDialog)
  LOCAL nROK, nOBDOBI
  LOCAL cFiltr
 /*
...
METHOD MZD_uctsastr_SCR:ItemMarked()
  Local  n, nTabPage := 0
  Local  dc      := ::drgDialog:dialogCtrl
