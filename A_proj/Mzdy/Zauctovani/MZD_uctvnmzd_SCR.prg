...
//-----+ FI_fakprihd_SCR +-------------------------------------------------------
CLASS MZD_uctvnmzd_SCR FROM drgUsrClass
EXPORTED:
...
*********************************************************************
METHOD MZD_uctvnmzd_SCR:Init(parent)
...
METHOD MZD_uctvnmzd_SCR:InFocus(oB)
 ::drgDialog:DialogCtrl:oBrowse := oB:cargo
RETURN .T.

**
METHOD MZD_uctvnmzd_SCR:drgDialogStart(drgDialog)
  LOCAL nROK, nOBDOBI
  LOCAL cFiltr
 /*
...
METHOD MZD_uctvnmzd_SCR:ItemMarked()
  Local  n, nTabPage := 0
  Local  dc      := ::drgDialog:dialogCtrl
