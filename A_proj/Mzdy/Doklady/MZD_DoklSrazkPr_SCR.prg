...
//-----+ FI_fakprihd_SCR +-------------------------------------------------------
CLASS MZD_doklsrazkpr_SCR FROM drgUsrClass
EXPORTED:
...
*********************************************************************
METHOD MZD_doklsrazkpr_SCR:Init(parent)
  ...
  M_SRZ->( DbSetRelation( 'C_SRAZKY',  { || UPPER(M_SRZ->cZkrSrazky)},  'UPPER(M_SRZ->cZkrSrazky)'))
  M_SRZ->( DbSetRelation( 'DRUHYMZD',  { || M_SRZ->nDruhMzdy },  'M_SRZ->nDruhMzdy'))
...
METHOD MZD_doklsrazkpr_SCR:InFocus(oB)
 ::drgDialog:DialogCtrl:oBrowse := oB:cargo
RETURN .T.

**
METHOD MZD_doklsrazkpr_SCR:drgDialogStart(drgDialog)
  LOCAL nROK, nOBDOBI
  LOCAL cFiltr
...
*****************************************************************
/*
METHOD MZD_doklsrazkpr_SCR:ItemMarked()
...
METHOD MZD_doklsrazkpr_SCR:ItemMarked()
  ...
  M_SRZ->( AdsSetOrder(1), dbSetScope(SCOPE_BOTH, cKy_BP),dbGOTOP())
...
METHOD MZD_doklsrazkpr_SCR:CardOfDoklPra()
LOCAL oDialog
  ::drgDialog:pushArea()                  // Save work area
  DRGDIALOG FORM 'MZD_doklsrazk_CRD' PARENT ::drgDialog MODAL DESTROY
