...
//-----+ FI_fakprihd_SCR +-------------------------------------------------------
CLASS MZD_doklsrazkdo_SCR FROM drgUsrClass
EXPORTED:
...
*********************************************************************
METHOD MZD_doklsrazkdo_SCR:Init(parent)
...
METHOD MZD_doklsrazkdo_SCR:InFocus(oB)
 ::drgDialog:DialogCtrl:oBrowse := oB:cargo
RETURN .T.

**
METHOD MZD_doklsrazkdo_SCR:drgDialogStart(drgDialog)
  LOCAL nROK, nOBDOBI
  LOCAL cFiltr
  ...
  M_SRZ->( ADS_SetAOF( cFiltr), dbGoTop())
...
*****************************************************************
/*
METHOD MZD_doklsrazkdo_SCR:ItemMarked()
...
/*METHOD MZD_doklsrazkdo_SCR:CardOfKmenMzd()
LOCAL oDialog
