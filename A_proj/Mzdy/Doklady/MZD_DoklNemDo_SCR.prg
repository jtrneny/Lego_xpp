...
//-----+ FI_fakprihd_SCR +-------------------------------------------------------
CLASS MZD_doklnemdo_SCR FROM drgUsrClass
EXPORTED:
...
*********************************************************************
METHOD MZD_doklnemdo_SCR:Init(parent)
...
METHOD MZD_doklnemdo_SCR:InFocus(oB)
 ::drgDialog:DialogCtrl:oBrowse := oB:cargo
RETURN .T.

**
METHOD MZD_doklnemdo_SCR:drgDialogStart(drgDialog)
 LOCAL nROK, nOBDOBI
  LOCAL cFiltr
...
*****************************************************************
/*
METHOD MZD_doklnemdo_SCR:ItemMarked()
...
METHOD MZD_doklnemdo_SCR:ItemMarked()
  ...
  cKy_BP := StrZero( MSPRC_MO->nOscisPrac, 5)
  M_NEMOC->( AdsSetOrder(1), dbSetScope(SCOPE_BOTH, cKy_BP),dbGOTOP())

  cKy_BP := StrZero( M_NEMOC->nOsCisPrac, 5)+ STRZERO( M_NEMOC->nPorPraVzt,3) + StrZero( M_NEMOC->nPoradi, 6)
  M_NEM->( AdsSetOrder(8), dbSetScope(SCOPE_BOTH, cKy_BP),dbGOTOP())
...
/*METHOD MZD_doklnemdo_SCR:CardOfKmenMzd()
LOCAL oDialog
