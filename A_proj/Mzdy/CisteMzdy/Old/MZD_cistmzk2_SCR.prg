...
//-----+ FI_fakprihd_SCR +-------------------------------------------------------
CLASS MZD_cistmzk2_SCR FROM drgUsrClass
EXPORTED:
...
*********************************************************************
METHOD MZD_cistmzk2_SCR:Init(parent)
...
METHOD MZD_cistmzk2_SCR:InFocus(oB)
 ::drgDialog:DialogCtrl:oBrowse := oB:cargo
RETURN .T.

**
METHOD MZD_cistmzk2_SCR:drgDialogStart(drgDialog)
  LOCAL nROK, nOBDOBI
  LOCAL cFiltr
/*
...
METHOD MZD_cistmzk2_SCR:ItemMarked()
  Local  n, nTabPage := 0
  Local  dc      := ::drgDialog:dialogCtrl
