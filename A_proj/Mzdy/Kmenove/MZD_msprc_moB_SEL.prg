...
function mzd_kmenove_sel_moB(cfield)
  ...
  osoby->( dbseek( osoby->ncisOsoby,, 'MSPRMO13'))
  return msPrc_moB->(fieldGet(npos))
*/


*  MSPRC_MO
** CLASS MZD_msprc_moB_SEL ****************************************************
CLASS MZD_msprc_moB_SEL FROM drgUsrClass
EXPORTED:
  var     obdobi
...
METHOD MZD_msprc_moB_SEL:Init(parent)
  ...
  cfiltr := Format("nROKOBD = %% .and. lstavem", {rokObd})
  ::drgDialog:set_prg_filter( cfiltr, 'msprc_mob')
return self


method MZD_msprc_moB_SEL:drgDialogStart(drgDialog)
  local  x, ocolumn
...
*  drgDump( msprc_moB->(ordSetFocus()) )
return self


method MZD_msprc_moB_SEL:itemSelected()

  PostAppEvent(xbeP_Close, drgEVENT_EXIT,,::drgDialog:dialog)
return self


method MZD_msprc_moB_SEL:createContext()
...
method MZD_msprc_moB_SEL:fromContext(aorder,p_popUp)
