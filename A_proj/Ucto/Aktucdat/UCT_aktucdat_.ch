...
{ "MZDY.EXE"                                                      , ;
    ...
    { { "MZDDAVHD"                                              , ;
        { "MZDDAVHD,1"                                          , ;
          ...
          NIL                                                   , ;
          NIL                                                   , ;
          { "UcetERRw ->cULOHA     := MZDDAVHD ->cULOHA"      , ;
            "UcetERRw ->cOBDOBI    := MZDDAVHD ->cOBDOBI"     , ;
            "UCETERRw ->nROK       := MZDDAVHD ->nROK"        , ;
            "UCETERRw ->nOBDOBI    := MZDDAVHD ->nOBDOBI"     , ;
            "UcetERRw ->cTASKs     := ('MZDY_hrubé mzdy')"    , ;
            "UcetERRw ->cDENIK     := MZDDAVHD ->cDENIK"      , ;
            "UcetERRw ->cDENIK_CFG := ('MZDY:cDENIKMZ_H')"    , ;
            "UcetERRw ->nDOKLAD    := MZDDAVHD ->nDOKLAD"     , ;
            "UcetERRw ->cTextDOK   := ('               ')"    , ;
            "UcetERRw ->nCenZakCEL := MZDDAVHD ->nHRUBAMZD"   , ;
            "UcetERRw ->nKLikvid   := MZDDAVHD ->nKLikvid"    , ;
            "UcetERRw ->nZLikvid   := MZDDAVHD ->nZLikvid"    , ;
            "UcetERRw ->nKcMD      := (0)"                    , ;
            "UcetERRw ->nKcDAL     := (0)"                    , ;
            "UcetERRw ->dDatUZV    := DATE()"                 , ;
            "UcetERRw ->cERR       := ('0000000')"              ;
          }                                                   , ;
          "UPPER( SYSCONFIG('MZDY:cDENIKMZ_H'))"                ;
        }                                                       , ;
    ...
    { { "MZDDAVHD"                                              , ;
        { "MZDDAVHD,1"                                          , ;
          ...
          { "UcetERRw ->cULOHA     := MZDDAVHD ->cULOHA"      , ;
            ...
            "UcetERRw ->cTASKs     := ('MZDY_hrubé mzdy')"    , ;
            "UcetERRw ->cDENIK     := MZDDAVHD ->cDENIK"      , ;
            "UcetERRw ->cDENIK_CFG := ('MZDY:cDENIKMZ_N')"    , ;
            "UcetERRw ->nDOKLAD    := MZDDAVHD ->nDOKLAD"     , ;
            "UcetERRw ->cTextDOK   := ('               ')"    , ;
            "UcetERRw ->nCenZakCEL := MZDDAVHD ->nHRUBAMZD"   , ;
            "UcetERRw ->nKLikvid   := MZDDAVHD ->nKLikvid"    , ;
          ...
          "UPPER( SYSCONFIG('MZDY:cDENIKMZ_N'))"                ;
        }                                                       , ;
    ...
    { { "MZDDAVHD"                                              , ;
        { "MZDDAVHD,1"                                          , ;
          ...
          { "UcetERRw ->cULOHA     := MZDDAVHD ->cULOHA"      , ;
            ...
            "UcetERRw ->cTASKs     := ('MZDY_hrubé mzdy')"    , ;
            "UcetERRw ->cDENIK     := MZDDAVHD ->cDENIK"      , ;
            "UcetERRw ->cDENIK_CFG := ('MZDY:cDENIKMZ_S')"    , ;
            "UcetERRw ->nDOKLAD    := MZDDAVHD ->nDOKLAD"     , ;
            "UcetERRw ->cTextDOK   := ('               ')"    , ;
            "UcetERRw ->nCenZakCEL := MZDDAVHD ->nHRUBAMZD"   , ;
            "UcetERRw ->nKLikvid   := MZDDAVHD ->nKLikvid"    , ;
          ...
          "UPPER( SYSCONFIG('MZDY:cDENIKMZ_S'))"                ;
        }                                                       , ;
...
{ "MZDY.EXE"                                                      , ;
    "mzdy ~Èisté mzdy       "                                       , ;
    " ··· pøehled úèetních zázmanù modulu MZDY_èisté mzdy ···"      , ;
    2                                                               , ;
    NIL                                                             , ;
    { { "MZDYHD"                                                , ;
        { "MZDYHD,1"                                            , ;
          ...
          NIL                                                   , ;
          NIL                                                   , ;
          { "UcetERRw ->cULOHA     := MZDYHD ->cULOHA"          , ;
            "UcetERRw ->cOBDOBI    := MZDYHD ->cOBDOBI"       , ;
            "UCETERRw ->nROK       := MZDYHD ->nROK"          , ;
            "UCETERRw ->nOBDOBI    := MZDYHD ->nOBDOBI"       , ;
            "UcetERRw ->cTASKs     := ('MZDY_èité mzdy')"     , ;
            "UcetERRw ->cDENIK     := MZDYHD ->cDENIK"        , ;
            "UcetERRw ->cDENIK_CFG := ('CM')"                 , ;
            "UcetERRw ->nDOKLAD    := MZDYHD ->nDOKLAD"       , ;
            "UcetERRw ->cTextDOK   := ('               ')"    , ;
            "UcetERRw ->nCenZakCEL := MZDYHD ->nCISTPRIJE"    , ;
            "UcetERRw ->nKLikvid   := MZDYHD ->nKLikvid"      , ;
            "UcetERRw ->nZLikvid   := MZDYHD ->nZLikvid"      , ;
            "UcetERRw ->nKcMD      := (0)"                    , ;
            "UcetERRw ->nKcDAL     := (0)"                    , ;
            "UcetERRw ->dDatUZV    := DATE()"                 , ;
            "UcetERRw ->cERR       := ('0000000')"              ;
        ...
        "Úèetní záznamy MZDY_èisté mzdy"                          ;
      }                                                           ;
    }                                                             , ;
    .T.                                                               ;
  }
