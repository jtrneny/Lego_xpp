...
CLASS UCT_uctvykhd_IN FROM drgUsrClass, FIN_finance_IN
exported:
  var     lnewRec, oinf
...
method UCT_uctvykhd_IN:init(parent)
...
method UCT_uctvykhd_IN:drgDialogStart(drgDialog)
  local nOBDOBI
  local cFiltr
...
method UCT_uctvykhd_IN:tabSelect(oTabPage,tabnum)
  local cfiltr
...
method UCT_uctvykhd_IN:itemMarked()
  local  cfiltr
...
method UCT_uctvykhd_IN:drgDialogEnd()
return


method UCT_uctvykhd_IN:postDelete()
...
method UCT_uctvykhd_IN:aktVykazu()
  local cidvyk
  local ctypvyk
  local cfiltr
  local acfgvyk
