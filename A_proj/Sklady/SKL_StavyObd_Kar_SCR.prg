...
********************************************************************************
CLASS SKL_StavyObd_Kar_SCR FROM drgUsrClass
EXPORTED:
...
********************************************************************************
METHOD SKL_StavyObd_Kar_SCR:init(parent)
  *
...
********************************************************************************
METHOD SKL_StavyObd_Kar_SCR:drgDialogStart(drgDialog)
...
METHOD SKL_StavyObd_Kar_SCR:obd_Changed()
...
********************************************************************************
METHOD SKL_StavyObd_Kar_SCR:createKUMUL()
  Local cKey := Upper(CenZboz->cCisSklad) + Upper(CenZboz->cSklPol)
  Local nMes, cKarta
  Local saveTmp
  *
...
********************************************************************************
METHOD SKL_StavyObd_Kar_SCR:SKL_KUMUL()
...
********************************************************************************
METHOD SKL_StavyObd_Kar_SCR:copyToKUMUL()
  Local cTAG
  Local cMsg := drgNLS:msg('MOMENT PROSÍM - generuji váš požadavek ...')
