...
* VYR_VYRPOL_SEL ...
*****************************************************************
CLASS VYR_VYRPOL_SEL FROM drgUsrClass
...
*****************************************************************
METHOD VYR_VYRPOL_SEL:init(parent)
...
**********************************************************************
METHOD VYR_VYRPOL_SEL:eventHandled(nEvent, mp1, mp2, oXbp)
...
********************************************************************************
METHOD VYR_VYRPOL_SEL:doAppend( nEvent)
  LOCAL oDialog, nExit
...
// zkontrolujeme a pak ven
  IF nExit = drgEVENT_SAVE
*    ::OnSave(,, oDialog )
    oDialog:dataManager:save()
    IF( oDialog:dialogCtrl:isAppend, VYRPOL->( DbAppend()), Nil )
    IF VYRPOL->(sx_RLock())
