...
EXPORTED:
  ...
  ** edit
  ...
  inline method OnAfterCellEdit(oTree,Item,ColIndex,NewCaption)
    ...
    *
    local  ncnt, nIn, x, hChild, hc, recNo
    ...
    *
    ...
    if KusTree->nmnozZadan <> val(NewCaption)
      oTree:BeginUpdate()
      ...
      if( hParent := oItems:ItemParent(Item)) = 0 // Root item
        ...
        ** root
        ...
        do while .not. kusTree->( eof())
          KusTree->nmnozZadan := mnozZadan  //val(NewCaption)
          KusTree->nspMNOnas  := KusTree->nSpMno    *KusTree->nmnozZadan
          KusTree->nrozD_NAS  := KusTree->nmnozDzbo -KusTree->nSpMnoNas
...
//    oColumn:AutoSearch   := .f.
  ...
  hRoot  := oItems:addItem(citem)
            ...
            oItems:SetProperty("CellCaption",hRoot, 4,KusTree->nSpMno    )
            oItems:SetProperty("CellCaption",hRoot, 5,KusTree->nmnozZadan)
            oItems:SetProperty("CellCaption",hRoot, 6,KusTree->cmjSpo    )
            oItems:SetProperty("CellCaption",hRoot, 7,KusTree->nspMNOnas )
            oItems:SetProperty("CellCaption",hRoot, 8,KusTree->nmnozDzbo )
            oItems:SetProperty("CellCaption",hRoot, 9,KusTree->nrozD_NAS )
          ...
          if anode[x,3]
             if vysPol = anode[x,4]
               hc := oItems:InsertItem( h, 0, citem  )
                     ...
                     oItems:SetProperty("CellCaption",hc, 4, KusTree->nSpMno    )
                     oItems:SetProperty("CellCaption",hc, 5, KusTree->nmnozZadan)
                     oItems:SetProperty("CellCaption",hc, 6, KusTree->cmjSpo    )
                     oItems:SetProperty("CellCaption",hc, 7, KusTree->nspMNOnas )
                     oItems:SetProperty("CellCaption",hc, 8, KusTree->nmnozDzbo )
                     oItems:SetProperty("CellCaption",hc, 9, KusTree->nrozD_NAS )
                     *
            ...
            h := oItems:InsertItem( hRoot, 0, citem  )
                 ...
                 oItems:SetProperty("CellCaption", h, 4, KusTree->nSpMno    )
                 oItems:SetProperty("CellCaption", h, 5, KusTree->nmnozZadan)
                 oItems:SetProperty("CellCaption", h, 6, KusTree->cmjSpo    )
                 oItems:SetProperty("CellCaption", h, 7, KusTree->nspMNOnas )
                 oItems:SetProperty("CellCaption", h, 8, KusTree->nmnozDzbo )
                 oItems:SetProperty("CellCaption", h, 9, KusTree->nrozD_NAS )
                 *
