...
//                   drgDump( "dtskBegin  --->"  + dtoc(dtskBegin) + CRLF)
//                   drgDump( "ctskBegTm  --->"  + ctskBegTm + CRLF)
//                   drgDump( "njd_tskBegin  --->"  + Str(njd_tskBegin) + CRLF)
...
//            drgDump( "Služba se startuje" + CRLF)
...
//           drgDump( "paTask.njd_tskBegin  --->"  + Str(paTask.njd_tskBegin) + CRLF)
//           drgDump( "njd_Current  --->"          + Str(njd_Current) + CRLF)
//           drgDump( "paTask.ntypRun  --->"       + Str(paTask.ntypRun) + CRLF)
//           drgDump( "paTask.njd_tskDenBeg  --->" + Str(paTask.njd_tskDenBeg) + CRLF)
//           drgDump( "paTask.njd_tskDenEnd  --->" + Str(paTask.njd_tskDenEnd) + CRLF)
...
//            drgDump( "úloha musí být za den spuštìna jen jednou" + CRLF)
//            drgDump( "paTask.njd_tskBegin  --->"  + Str(paTask.njd_tskBegin) + CRLF)
//            drgDump( "paTask.njd_tskDenBeg --->"  + Str(paTask.njd_tskDenBeg) + CRLF)
//            drgDump( "paTask.njd_tskDenEnd --->"  + Str(paTask.njd_tskDenEnd) + CRLF)
//            drgDump( "njd_Current  --->"          + Str(njd_Current) + CRLF)
...
//                drgDump( "nn           --->"  + Str(nn) + CRLF)
                mm := nn + paTask.nperioda
//                drgDump( "paTask.nperioda--->"  + Str(paTask.nperioda) + CRLF)
//                drgDump( "mm           --->"  + Str(mm) + CRLF)
                if mm >= 86400
                  nn := mm - 86400
                  paTask.ctskBegin := secTime( nn)
//                  drgDump( "paTask.ctskBegin--->"  + Str(paTask.ctskBegin) + CRLF)
...
//                 drgDump( "1.pøiøazení" + CRLF)
//                 drgDump( "paTask.dtskBegin  --->"  + dtoc(paTask.dtskBegin) + CRLF)
//                 drgDump( "paTask.ctskBegin  --->"  + paTask.ctskBegin + CRLF)
//                 drgDump( "paTask.njd_tskBegin  --->"  + Str(paTask.njd_tskBegin) + CRLF)
...
//                   drgDump( "2.pøiøazení" + CRLF)
//                   drgDump( "paTask.dtskBegin  --->"  + dtoc(paTask.dtskBegin) + CRLF)
//                   drgDump( "paTask.ctskBegin  --->"  + paTask.ctskBegin + CRLF)
//                   drgDump( "paTask.njd_tskBegin  --->"  + Str(paTask.njd_tskBegin) + CRLF)
//                   drgDump( "----------------------------------------------------" + CRLF)
//                   drgDump( "paTask.ctskDenBeg  --->"  + paTask.ctskDenBeg + CRLF)
//                   drgDump( "paTask.njd_tskBegin  --->"  + Str(paTask.njd_tskBegin) + CRLF)
