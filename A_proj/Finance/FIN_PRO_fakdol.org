...
exported:
  ...
  * ntypPreDan a nprodDPHpp se edituje pouze pro nradVykDPH = 25, jinak není ani viditelný
  ...
  * jen pro fakvysitw je možno editovat ntypPreDan a nprocDPHpp
...
*                                        saveOk := 1 // if( ::postValidateForm(file_name), 1, 0)
...
method FIN_PRO_fakdol:postValidate(drgVar)
  ...
  local  n_roundDph  := SysConfig('Finance:nRoundDph'), n_zaklDan, n_procDan, n_sazDan, n_procSlev
...
method fin_pro_fakdol:fin_vykdph_rv_sel(drgDialog)
  ...
  *
  ...
  if nexit != drgEVENT_QUIT .or. ok
    ...
    *
    ** ntypPreDan a nprodDPHpp se edituje pouze pro nradVykDPH = 25
