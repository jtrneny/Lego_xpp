...
FUNCTION FIN_dph_2015_obd(nrok, inInsert)
  LOCAL  aCOMBO_val := {}
...
**
** CLASS for FIN_dph_2015_SCR **************************************************
CLASS FIN_dph_2015_SCR FROM drgUsrClass
EXPORTED:
...
METHOD FIN_dph_2015_SCR:init(parent)
...
METHOD FIN_dph_2015_SCR:destroy()
  ::drgUsrClass:destroy()

  ::nrok        := NIL

  if(select('dph_2015') <> 0, DPH_2015 ->(Ads_ClearAOF()), nil)
RETURN


METHOD FIN_dph_2015_SCR:comboBoxInit(drgComboBox)
  LOCAL  nIn
  LOCAL  aROK_zpr   := {}
  LOCAL  aCOMBO_val := {}
...
METHOD FIN_dph_2015_SCR:drgDialogStart(drgDialog)

  ::brow := drgDialog:dialogCtrl:oBrowse[1]
  ::msg  := drgDialog:oMessageBar             // messageBar
  ::dm   := drgDialog:dataManager             // dataMabanager

  DPH_2015 ->( Ads_SetAof("nROK = " +STR(::nrok,4)), dbGoTop() )
...
METHOD FIN_dph_2015_SCR:comboItemSelected(mp1, mp2, o)
...
*
** RUN METHOD
METHOD FIN_dph_2015_SCR:dph_Insert()
  LOCAL oDialog, nExit

  DRGDIALOG FORM 'FIN_DPH_2015_INS' PARENT ::drgDialog MODAL DESTROY ;
                                    EXITSTATE nExit
...
method FIN_dph_2015_SCR:dph_Delete()
  local oDialog, nExit

  DRGDIALOG FORM 'FIN_DPH_2015_DEL' PARENT ::drgDialog MODAL DESTROY ;
                                    EXITSTATE nExit
...
method fin_dph_2015_scr:dph_Edit()
