...
*  RODINNÍ PØÍSLUŠNÍCI
** CLASS PER_rodprisl_IN ******************************************************
CLASS PER_rodprisl_IN FROM drgUsrClass, MZD_kmenove_IN
EXPORTED:
...
METHOD PER_rodprisl_IN:init(parent)
  *
...
METHOD PER_rodprisl_IN:drgDialogStart(drgDialog)
  LOCAL  x, cfield
  local  tabNum
...
METHOD PER_rodprisl_IN:postValidate(drgVar, lis_formValidate)
...
METHOD PER_rodprisl_IN:onSave(lIsCheck,lIsAppend)
...
METHOD PER_rodprisl_IN:destroy()
 ::drgUsrClass:destroy()
