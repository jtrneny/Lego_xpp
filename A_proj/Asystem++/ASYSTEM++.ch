...
// WIN10 - 64bit - sid vrací NULL value
// #xtranslate  .sid    => ->( isNull( sid, 0 ) )
...
#xtranslate CopyDBWithScope(<tg>,<cs>,<in>,<ou>,<ms>) => ;
   ( drgDBMS:open(<in>)                                       , ;
     ...
     (<in>) ->(DbGoTop())                                     , ;
     (<in>) ->(DbEval( { || mh_COPYFLD(<in>,<ou>,.T.,<ms>) })), ;
     (<in>) ->(DBClearScope())                                , ;
     FORDREC()                                                  )
...
# define  F_BANKAPR         'FBANKAPR       '

# define  E_DODLISTY        'EDODLISTY      '
# define  E_OBJEDNAVKY      'EOBJEDNAVKY    '         // objednávky pøijaté   OBJHEAD
# define  E_NABIDKY         'ENABIDKY       '         // nabídky vystavené    NABVYSHD
# define  E_REGPOKLADNA     'EREGPOKLADNA   '
# define  E_EXPEDICE        'EEXPEDICE'

# define  M_ZAVAZKY         'MZAVAZKY       '

# define  N_DODLISTY        'NDODLISTY      '         // dodací listy pøijaté DODLSTPHD
# define  N_OBJEDNAVKY      'NOBJEDNAVKY    '         // objednávky vystavené OBJVYSHD
# define  N_NABIDKY         'NNABIDKY       '         // nabídky pøijaté      NABPRIHD
...
*
** definice úrovnì nákladové struktury
# define  paDEFc_naklst     { { 'cnazPol1', .t. }, { 'cnazPol2', .t. }, { 'cnazPol3', .t. }, ;
                              { 'cnazPol4', .t. }, { 'cnazPol5', .t. }, { 'cnazPol6', .t. }  }
...
#xtranslate  .drgEmpty =>  \[12\]

*
** vazba na ctypPohybu.comboItemSelect
#xtranslate .ctyppohybu    =>  \[ 1\]
#xtranslate .cnaztyppoh    =>  \[ 2\]
#xtranslate .ctypdoklad    =>  \[ 3\]
#xtranslate .ctypcrd       =>  \[ 4\]
#xtranslate .ctask         =>  \[ 5\]
#xtranslate .csubtask      =>  \[ 6\]
#xtranslate .craddph091    =>  \[ 7\]
#xtranslate .cvypSAZdan    =>  \[ 8\]
#xtranslate .npokladEET    =>  \[ 9\]
#xtranslate .ctypKurzu     =>  \[10\]
...
#define      GRA_FILTER_OPTLEVEL { { 341  , { GraMakeRGBColor({204,255,230}) , ;
                                              GraMakeRGBColor({  9,255,132}) , ;
                                              GraMakeRGBColor({  0,128, 64})   } }, ;
                                   { 342  , { GraMakeRGBColor({255,255,187}) , ;
                                              GraMakeRGBColor({255,255, 98}) , ;
                                              GraMakeRGBColor({255,255,  0})   } }, ;
                                   { 343  , { GraMakeRGBColor({255,185,185}) , ;
                                              GraMakeRGBColor({255,108,108}) , ;
                                              GraMakeRGBColor({255,  0,  0})   } }  }

* aktivnní a neaktivní barva pro BRO
#define      ACTIVE_BRO_COLOR    GRA_CLR_WHITE
#define    NOACTIVE_BRO_COLOR    graMakeRGBColor({ 233, 233, 230 })
*  #define    NOACTIVE_BRO_COLOR    graMakeRGBColor({ 247, 247, 247 })