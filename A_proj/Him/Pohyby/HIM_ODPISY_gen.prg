...
*            (::fiMAJ)->nPocMesOdp += 1
      ...
      ** new_HIM
      ...
      IF ((::fiMAJ)->cOdpiSkD = '1M'  .or. (::fiMAJ)->cOdpiSkD = '2M'  .or. ;
          (::fiMAJ)->cOdpiSkD = '1M1' .or. (::fiMAJ)->cOdpiSkD = '2M2' .or. ;
          (::fiMAJ)->cOdpiSkD = '10'  .or. (::fiMAJ)->cOdpiSkD = '11'  .or. ;
          (::fiMAJ)->cOdpiSkD = '12'  .or. (::fiMAJ)->cOdpiSkD = '13'       )

        npocMesDO := (::fiMAJ)->nPocMesDO +1
        nmesOdpiD := c_danSKP->nmesOdpiD

        IF (::fiMAJ)->nZnAktD == AKTIVNI .and. ( (::fiMAJ)->nCenaVstD - (::fiMAJ)->nOprDan) > 0
           (::fiMAJ)->nPocMesDO := if( nmesOdpiD <> 0, min( npocMesDO, nmesOdpiD), nPocMesDO )
// js           (::fiMAJ)->nPocMesDO += 1
        ENDIF
      ENDIF
      *
      (::fiMAJ)->( dbSkip())
