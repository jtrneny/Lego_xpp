...
USERDEF MANIFEST
  MANIFEST_RESID = FILE "Aservice.exe.manifest"

VERSION
   "CompanyName"      = "MISS Software, s.r.o."
   "FileDescription"  = "Asystem++_setup"
   "ProductName"      = "Asystem++_setup"
   "LegalCopyright"   = "Copyright (c) 2005-2010"
   "OriginalFilename" = "Asystem++_setup.exe"


#include "..\..\A_rsrc\ASYSTEM++_ver_DB.arc"
