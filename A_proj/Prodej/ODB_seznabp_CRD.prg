...
**  ODB_SEZNABP ->( OrdSetFOCUS(1), dbSetScope(SCOPE_BOTH, STRZERO(FIR_FIRMY ->nCISFIRMY)),dbGOTOP())
  cKy_pol := STRZERO(ODB_SEZNABP ->nCISFIRMY,5) +STRZERO(ODB_SEZNABP ->nCISNAB)
  ODB_POLNABP ->( OrdSetFOCUS(6), dbSetScope(SCOPE_BOTH, cKY_pol), dbGOTOP())
RETURN SELF
