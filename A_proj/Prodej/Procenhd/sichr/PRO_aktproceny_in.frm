...
* 1 - procenhd
  ...
  TYPE(DBrowse) FPOS(0,7.2) SIZE(109,18) FILE(AktProcI)  ;
                FIELDS( ccisSklad:èísSklad             , ;
                        ...
                        nprocDph:dph                   , ; 
                        nprocento:% slevy              , ;  
                        nCeJPrZBZ:záklCenaBDanì        , ;
                        nCeJPrKBZ:koncCenaBDanì        , ;
                        nCeJPrKDZ:záklCenaSDaní        , ;
                        nCeJPrZDZ:koncCenaSDaní        , ;
                        NCENAPZBO:prodejníCena         ) ;
