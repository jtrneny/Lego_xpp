...
// Portions Copyright (c) 2005-2013, iAnywhere Solutions, Inc.
...
#else
   /*
    * Note:  in VS2005, when /Zc:wchar_t is used, "#if !defined( WCHAR )" is not
    * sufficient to prevent a type redefinition compiler error.  Add the second
    * condition to prevent the error.  _WCHAR_T_DEFINED will only be defined in VS.
    */
   #if !defined( WCHAR ) && !defined( _WCHAR_T_DEFINED )
      typedef unsigned short WCHAR;
   #endif
#endif
...
/* SQL Timeout value */
#define ADS_DEFAULT_SQL_TIMEOUT       0x0000  // Default client SQL timeout.
 ...
 */
#define ADS_RESPECT_RIGHTS_CHECKING   0x00000001   // pre v10 behavior
#define ADS_IGNORE_RIGHTS_CHECKING    0x00000002   // post v10 behavior
...
#define ADS_UCHAR_KEY_SHORT           0x20000000
...
#define ADS_WSTRINGKEY           8   /* data given as a UTF16 string */
...
#define ADS_CONNECTIONPROP_PROTOCOL          2
#define ADS_CONNECTIONPROP_ENCRYPTION_TYPE   3
#define ADS_CONNECTIONPROP_FIPS_MODE         4
#define ADS_CONNECTIONPROP_CERTIFICATE_FILE  5
#define ADS_CONNECTIONPROP_CIPHER_SUITE      6
#define ADS_CONNECTIONPROP_COMMON_NAME       7


#define ADS_CONNECTIONPROP_USING_TCP_IP      1
#define ADS_CONNECTIONPROP_USING_TLC         5
...
#define AE_UNSUPPORTED_COLLATION        5049
...
#define AE_SERVER_ENUMERATION_ERROR     5213
#define AE_UNABLE_TO_LOAD_SSL           5214
#define AE_UNABLE_TO_VERIFY_SIGNATURE   5215
#define AE_UNABLE_TO_LOAD_SSL_ENTRYPOINT 5216
#define AE_CRYPTO_ERROR                 5217
#define AE_UNRECOGNIZED_CIPHER          5218
#define AE_FIPS_MODE_ENCRYPTION         5219  /* FIPS mode encryption violation */
#define AE_FIPS_REQUIRED                5220
#define AE_FIPS_NOT_ALLOWED             5221
#define AE_FIPS_MODE_FAILED             5222
#define AE_PASSWORD_REQUIRED            5223  /* the additional error info should include details on type of password */
...
#define ADS_ENCRYPTION_RC4       3   /* RC4 Encryption */
#define ADS_ENCRYPTION_AES128    5   /* 128-bit AES in CTR mode, PBKDF2 key derivation */
#define ADS_ENCRYPTION_AES256    6   /* 256-bit AES in CTR mode, PBKDF2 key derivation */
...
#define ADS_DD_INDEX_FTS_DELIMITERS_W  412
#define ADS_DD_INDEX_FTS_NOISE_W       413
#define ADS_DD_INDEX_FTS_DROP_CHARS_W  414
#define ADS_DD_INDEX_FTS_CONDITIONAL_CHARS_W 415
...
#define ADS_DD_SUBSCR_COMM_TLS            1715    // boolean flag:  TRUE for TLS communications
#define ADS_DD_SUBSCR_CONNECTION_STR      1716    // Free form connection string for new AdsConnect101 API

/* AdsMgKillUser90 Constants */
#define ADS_PROPERTY_UNSPECIFIED   0x0000
#define ADS_DONT_KILL_APPID        0x0001
#define ADS_RESTRICT_KILL          0x0002
...
#define ADS_FS_MULTICAST_ONLY    0x00000001  // Only perform multicast step
#define ADS_FS_CONNECT_ALL       0x00000002  // Attempt to connect to every address returned
...
#define ADS_ENCRYPT_STRING_RC4             "RC4"
#define ADS_ENCRYPT_STRING_AES128          "AES128"
#define ADS_ENCRYPT_STRING_AES256          "AES256"


/* Connection string cipher suite options as strings. */
#define ADS_CIPHER_SUITE_STRING_RC4         "RC4-MD5"
...
UNSIGNED32 ENTRYPOINT AdsConnect101( UNSIGNED8 *pucConnectString,
                                     ADSHANDLE *phConnectionOptions,
                                     ADSHANDLE *phConnect );
typedef UNSIGNED32 (WINAPI *ADSCONNECT101_PTR)( UNSIGNED8 *pucConnectString,
                                                ADSHANDLE *phConnectionOptions,
                                                ADSHANDLE *phConnect );

UNSIGNED32 ENTRYPOINT AdsClearCachePool( UNSIGNED8 *pucConnectString );
typedef UNSIGNED32 (WINAPI *ADSCLEARCACHEPOOL_PTR)( UNSIGNED8 *pucConnectString );

UNSIGNED32 ENTRYPOINT AdsReapUnusedConnections( void );
typedef UNSIGNED32 (WINAPI *ADSREAPUNUSEDCONNECTIONS_PTR)( void );
...
UNSIGNED32 ENTRYPOINT AdsDDCreate101( UNSIGNED8 *pucConnectString,
                                      ADSHANDLE *phConnectOptions,
                                      ADSHANDLE *phDictionary );
typedef UNSIGNED32 (WINAPI *ADSDDCREATE101_PTR)( UNSIGNED8 *pucConnectString,
                                      ADSHANDLE *phConnectOptions,
                                      ADSHANDLE *phDictionary );
...
UNSIGNED32 ENTRYPOINT AdsDDAddProcedure100( ADSHANDLE  hDictionary,
                                            UNSIGNED8  *pucName,
                                            WCHAR      *pwcContainer,
                                            UNSIGNED8  *pucProcName,
                                            UNSIGNED32 ulInvokeOption,
                                            ...
                                            UNSIGNED8  *pucOutParams,
                                            UNSIGNED8  *pucComments );
typedef UNSIGNED32 (WINAPI *ADSDDADDPROCEDURE100_PTR)( ADSHANDLE  hDictionary,
                                         UNSIGNED8  *pucName,
                                         WCHAR      *pwcContainer,
                                         UNSIGNED8  *pucProcName,
                                         UNSIGNED32 ulInvokeOption,
...
UNSIGNED32 ENTRYPOINT AdsDDAddView100( ADSHANDLE      hDictionary,
                                       UNSIGNED8      *pucName,
                                       UNSIGNED8      *pucComments,
                                       WCHAR          *pwcSQL );
typedef UNSIGNED32 (WINAPI *ADSDDADDVIEW100_PTR)( ADSHANDLE      hDictionary,
                                                  UNSIGNED8      *pucName,
                                                  UNSIGNED8      *pucComments,
                                                  WCHAR          *pwcSQL );
...
UNSIGNED32 ENTRYPOINT AdsDDCreateTrigger100( ADSHANDLE      hDictionary,
                                             UNSIGNED8      *pucName,
                                             UNSIGNED8      *pucTableName,
                                             UNSIGNED32     ulTriggerType,
                                             UNSIGNED32     ulEventTypes,
                                             ...
                                             UNSIGNED8      *pucComments,
                                             UNSIGNED32     ulOptions );
typedef UNSIGNED32 (WINAPI *ADSDDCREATETRIGGER100_PTR)( ADSHANDLE      hDictionary,
                                                        UNSIGNED8      *pucName,
                                                        UNSIGNED8      *pucTableName,
                                                        UNSIGNED32     ulTriggerType,
                                                        UNSIGNED32     ulEventTypes,
...
UNSIGNED32 ENTRYPOINT AdsDDCreateArticle100( ADSHANDLE      hDictionary,
                                             ...
                                             WCHAR          *pwcFilter,
                                             UNSIGNED32     ulOptions );
typedef UNSIGNED32 (WINAPI *ADSDDCREATEARTICLE100_PTR)( ADSHANDLE      hDictionary,
                                             UNSIGNED8      *pucPublicationName,
                                             UNSIGNED8      *pucObjectName,
                                             UNSIGNED8      *pucRowIdentColumns,
                                             WCHAR          *pwcFilter,
...
UNSIGNED32 ENTRYPOINT AdsEvalLogicalExprW(
                              ADSHANDLE        hTable,
                              WCHAR            *pwcExpr,
                              UNSIGNED16       *pbResult );
typedef UNSIGNED32 (WINAPI *ADSEVALLOGICALEXPRW_PTR)(
                              ADSHANDLE        hTable,
                              WCHAR            *pwcExpr,
                              UNSIGNED16       *pbResult );
...
UNSIGNED32 ENTRYPOINT AdsGetFTSIndexInfoW(
                              ADSHANDLE   hIndex,
                              WCHAR       *pwcOutput,
                              UNSIGNED32  *pulBufLen,
                              WCHAR       **ppwcField,
                              ...
                              WCHAR       **ppwcReserved2,
                              UNSIGNED32  *pulOptions );
typedef UNSIGNED32 (WINAPI *ADSGETFTSINDEXINFOW_PTR)(
                              ADSHANDLE   hIndex,
                              WCHAR       *pucOutput,
                              UNSIGNED32  *pulBufLen,
                              WCHAR       **ppwcField,
...
UNSIGNED32 ENTRYPOINT AdsGetIntProperty(
                              ADSHANDLE  hObj,
                              UNSIGNED32 ulPropertyID,
                              UNSIGNED32 *pulProperty );
typedef UNSIGNED32 (WINAPI *ADSGETINTPROPERTY_PTR )(
                                                    ADSHANDLE  hObj,
                                                    UNSIGNED32 ulPropertyID,
                                                    UNSIGNED32 *pulProperty );
...
typedef UNSIGNED32 (WINAPI *ADSGETTRANSACTIONCOUNT_PTR)(
                              ADSHANDLE        hConnect,
                              UNSIGNED32       *pulTransactionCount );
...
UNSIGNED32 ENTRYPOINT AdsGetFieldW( ADSHANDLE       hObj,
                                    UNSIGNED8       *pucFldName,
                                    WCHAR           *pwcBuf,
                                    UNSIGNED32      *pulLen,
                                    UNSIGNED16      usOption );
typedef UNSIGNED32 (WINAPI *ADSGETFIELDW_PTR)(
                                    ADSHANDLE       hObj,
                                    UNSIGNED8       *pucFldName,
                                    WCHAR           *pwcBuf,
                                    UNSIGNED32      *pulLen,
...
UNSIGNED32 ENTRYPOINT AdsGetStringW( ADSHANDLE       hObj,
                                     UNSIGNED8       *pucFldName,
                                     WCHAR           *pwcBuf,
                                     UNSIGNED32      *pulLen,
                                     UNSIGNED16      usOption );
typedef UNSIGNED32 (WINAPI *ADSGETSTRINGW_PTR)(
                                     ADSHANDLE       hObj,
                                     UNSIGNED8       *pucFldName,
                                     WCHAR           *pwcBuf,
                                     UNSIGNED32      *pulLen,
...
UNSIGNED32 ENTRYPOINT AdsOpenTable101(
                              ADSHANDLE        hConnect,
                              UNSIGNED8        *pucName,
                              ADSHANDLE        *phTable );
typedef UNSIGNED32 (WINAPI *ADSOPENTABLE101_PTR)(
                              ADSHANDLE        hConnect,
                              UNSIGNED8        *pucName,
                              ADSHANDLE        *phTable );
...
typedef UNSIGNED32 (WINAPI *ADSREGISTERCALLBACKFUNCTION_PTR)(
   ...
   UNSIGNED32 ENTRYPOINT AdsRegisterCallbackFunction101(
         UNSIGNED32 (WINAPI *lpfnCallback)( UNSIGNED16 usPercent, SIGNED64 qCallbackID ),
         SIGNED64 qCallbackID );
typedef UNSIGNED32 (WINAPI *ADSREGISTERCALLBACKFUNCTION101_PTR)(
         UNSIGNED32 (WINAPI *lpfnCallback)( UNSIGNED16 usPercent, SIGNED64 qCallbackID ),
         SIGNED64 qCallbackID );
...
typedef UNSIGNED32 (WINAPI *ADSCLEARCALLBACKFUNCTION_PTR)( void );
   ...
   UNSIGNED32 ENTRYPOINT AdsSetSQLTimeout( ADSHANDLE  hObj,
                                        UNSIGNED32 ulTimeout );
typedef UNSIGNED32 (WINAPI *ADSSETSQLTIMEOUT_PTR)( ADSHANDLE   hObj,
                                                   UNSIGNED32  ulTimeout );
#endif
...
UNSIGNED32 ENTRYPOINT AdsSetFieldW( ADSHANDLE       hObj,
                                    UNSIGNED8       *pucFldName,
                                    WCHAR           *pwcBuf,
                                    UNSIGNED32      ulLen );
typedef UNSIGNED32 (WINAPI *ADSSETFIELDW_PTR)(
                                    ADSHANDLE       hObj,
                                    UNSIGNED8       *pucFldName,
                                    WCHAR           *pwcBuf,
                                    UNSIGNED32      ulLen );
...
UNSIGNED32 ENTRYPOINT AdsSetFilter100( ADSHANDLE   hTable,
                                       VOID        *pvFilter,
                                       UNSIGNED32  ulOptions );
typedef UNSIGNED32 (WINAPI *ADSSETFILTER100_PTR)( ADSHANDLE    hTable,
                                                  VOID         *pvFilter,
                                                  UNSIGNED32  ulOptions );
...
UNSIGNED32 ENTRYPOINT AdsSetStringW( ADSHANDLE       hObj,
                                     UNSIGNED8       *pucFldName,
                                     WCHAR           *pwcBuf,
                                     UNSIGNED32      ulLen );
typedef UNSIGNED32 (WINAPI *ADSSETSTRINGW_PTR)(
                                     ADSHANDLE       hObj,
                                     UNSIGNED8       *pucFldName,
                                     WCHAR           *pwcBuf,
                                     UNSIGNED32      ulLen );
...
UNSIGNED32 ENTRYPOINT AdsSetAOF100( ADSHANDLE        hTable,
                                    VOID             *pvFilter,
                                    UNSIGNED32       ulOptions );
typedef UNSIGNED32 (WINAPI *ADSSETAOF100_PTR)( ADSHANDLE        hTable,
                                               VOID             *pvFilter,
                                               UNSIGNED32       uslptions );
...
UNSIGNED32 ENTRYPOINT AdsEvalAOF100( ADSHANDLE        hTable,
                                     VOID             *pvFilter,
                                     UNSIGNED32       ulOptions,
                                     UNSIGNED16       *pusOptLevel );
typedef UNSIGNED32 (WINAPI *ADSEVALAOF100_PTR)( ADSHANDLE        hTable,
                                                VOID             *pvFilter,
                                                UNSIGNED32       ulOptions,
                                                UNSIGNED16       *pusOptLevel );
...
UNSIGNED32 ENTRYPOINT AdsGetAOF100( ADSHANDLE        hTable,
                                    UNSIGNED32       ulOptions,
                                    VOID             *pvFilter,
                                    UNSIGNED32       *pulLen );
typedef UNSIGNED32 (WINAPI *ADSGETAOF100_PTR)( ADSHANDLE        hTable,
                                               UNSIGNED32       ulOptions,
                                               VOID             *pvFilter,
                                               UNSIGNED32       *pulLen );
...
UNSIGNED32 ENTRYPOINT AdsGetAOFOptLevel100( ADSHANDLE        hTable,
                                            UNSIGNED16       *pusOptLevel,
                                            VOID             *pvNonOpt,
                                            UNSIGNED32       *pulExprLen,
                                            UNSIGNED32       ulOptions );
typedef UNSIGNED32 (WINAPI *ADSGETAOFOPTLEVEL100_PTR)( ADSHANDLE        hTable,
                                                       UNSIGNED16       *pusOptLevel,
                                                       VOID             *pvNonOpt,
                                                       UNSIGNED32       *pulExprLen,
                                                       UNSIGNED32       ulOptions );
...
UNSIGNED32 ENTRYPOINT AdsBuildRawKey100( ADSHANDLE        hIndex,
                                         ...
                                         UNSIGNED16       *pusKeyLen,
                                         UNSIGNED32       ulOptions );
typedef UNSIGNED32 (WINAPI *ADSBUILDRAWKEY100_PTR)( ADSHANDLE        hIndex,
                                                    UNSIGNED8        *pucKey,
                                                    UNSIGNED16       *pusKeyLen,
                                                    UNSIGNED32       ulOptions );
...
UNSIGNED32 ENTRYPOINT AdsPrepareSQLW( ADSHANDLE hStatement,
                                      WCHAR *pwcSQL );
typedef UNSIGNED32 (WINAPI *ADSPREPARESQLW_PTR)( ADSHANDLE hStatement,
                                                 WCHAR *pwcSQL );

UNSIGNED32 ENTRYPOINT AdsCachePrepareSQL( ADSHANDLE hConnect,
                                          UNSIGNED8 *pucSQL,
                                          ADSHANDLE *phStatement );
typedef UNSIGNED32 (WINAPI *ADSCACHEPREPARESQL_PTR)( ADSHANDLE hConnect,
                                                     UNSIGNED8 *pucSQL,
                                                     ADSHANDLE *phStatement );
...
UNSIGNED32 ENTRYPOINT AdsCachePrepareSQLW( ADSHANDLE hConnect,
                                           WCHAR *pwcSQL,
                                           ADSHANDLE *phStatement );
typedef UNSIGNED32 (WINAPI *ADSCACHEPREPARESQLW_PTR)( ADSHANDLE hConnect,
                                                      WCHAR *pwcSQL,
                                                      ADSHANDLE *phStatement );
...
UNSIGNED32 ENTRYPOINT AdsExecuteSQLDirectW( ADSHANDLE hStatement,
                                            WCHAR     *pwcSQL,
                                            ADSHANDLE *phCursor );
typedef UNSIGNED32 (WINAPI *ADSEXECUTESQLDIRECTW_PTR)( ADSHANDLE hStatement,
                                                       WCHAR     *pwcSQL,
                                                       ADSHANDLE *phCursor );
...
UNSIGNED32 ENTRYPOINT AdsVerifySQLW( ADSHANDLE hStatement,
                                     WCHAR     *pwcSQL );
typedef UNSIGNED32 (WINAPI *ADSVERIFYSQLW_PTR)( ADSHANDLE hStatement,
                                                WCHAR     *pwcSQL );
...
UNSIGNED32 ENTRYPOINT AdsGetFieldLength100( ADSHANDLE  hTable,
                                            ...
                                            UNSIGNED32 ulOptions,
                                            UNSIGNED32 *pulLength );
typedef UNSIGNED32 (WINAPI *ADSGETFIELDLENGTH100_PTR)( ADSHANDLE   hTable,
                                                       UNSIGNED8*  pucFldName,
                                                       UNSIGNED32  ulOptions,
                                                       UNSIGNED32  *pulLength );
...
typedef UNSIGNED32 (WINAPI *ADSSETRIGHTSCHECKING_PTR)( UNSIGNED32 ulOptions );

UNSIGNED32 ENTRYPOINT AdsSetTableTransactionFree( ADSHANDLE  hTable,
                                                  UNSIGNED16 usTransFree );
typedef UNSIGNED32 (WINAPI *ADSSETTABLETRANSACTIONFREE_PTR)( ADSHANDLE  hTable,
                                                             UNSIGNED16 usTransFree );

UNSIGNED32 ENTRYPOINT AdsIsTableTransactionFree( ADSHANDLE  hTable,
                                                 UNSIGNED16 *pusTransFree );
typedef UNSIGNED32 (WINAPI *ADSISTABLETRANSACTIONFREE_PTR)( ADSHANDLE  hTable,
                                                            UNSIGNED16 *pusTransFree );
