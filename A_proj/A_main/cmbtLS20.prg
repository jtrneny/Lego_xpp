// Alaska Software Xbase++ module constants and function definitions for LS20.DLL
//  (c) combit GmbH
...
//
FUNCTION LS20ModuleInit()
  IF hDll == 0
    hDll = DllLoad("CMLS20.DLL")
    IF hDll == 0
...
LL_FUNCTION LsGetViewerControlClassNameEx() ORDINAL 93
LL_FUNCTION LsGetDebug() ORDINAL 94
LL_FUNCTION LsJobOpen() ORDINAL 99
LL_PROCEDURE LsJobClose(hLsJob) ORDINAL 100
