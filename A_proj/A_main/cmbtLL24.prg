// Alaska Software Xbase++ module constants and function definitions for LL24.DLL
//  (c) combit GmbH
//  [build of 2018-10-02 09:10:41]
...
//
FUNCTION LL24ModuleInit()
  IF hDll == 0
    hDll = DllLoad("CMLL24.DLL")
    IF hDll == 0
...
LL_FUNCTION LlSetNotificationCallback(hLlJob, lpfnNotify) ORDINAL 17
...
LL_FUNCTION LlDesignerProhibitFunctionGroup(hJob, nGroupFlags) ORDINAL 337
...
LL_FUNCTION LlSetNotificationCallbackExt(hLlJob, nEvent, lpfnNotify) ORDINAL 100
...
LL_FUNCTION LlDesignerTriggerJobInUIThread(hLlJob, nUserData) ORDINAL 293
LL_FUNCTION LlJobOpenCopyEx(hJob, nFlags) ORDINAL 299
LL_FUNCTION LlUtilsLcidFromLocaleName(@pszLocaleName) ORDINAL 319
LL_FUNCTION LlDesignerShowMessage(hJob, @pszTitle, @pszMessage, nFlags) ORDINAL 320
LL_FUNCTION LlUtilsGetProjectType(hJob, @pszProjectFilename) ORDINAL 325
LL_FUNCTION LlGetLastErrorText(hJob, @pszBuffer, nBufSize) ORDINAL 327
LL_FUNCTION LlProjectFindAndReplace(hJob, @pszSearchText, @pszReplaceText, nSARFlags) ORDINAL 312
