// Alaska Software Xbase++ header constants and function definitions for LS20.DLL
//  (c) combit GmbH
//  [build of 2014-09-10 15:09:39]

// HEADER file to be included in all modules using LS20

#ifndef _LS20_CH // include header only once
#define _LS20_CH
...
#define LS_VIEWERCONTROL_SUPPORTS_REALDATAEXPORT (WM_USER+66)        
...
#define LS_VIEWERCONTROL_QUEST_EXPANDABLEREGIONSJOBSUPPORT (29)                 /* 1 to allow (default), 0 to deny (if provider cannot handle multiple threads or so) */
#define LS_VIEWERCONTROL_NTFY_INTERACTIVESORTINGJOB (30)                
#define LS_VIEWERCONTROL_QUEST_INTERACTIVESORTINGJOBSUPPORT (31)                 /* 1 to allow (default), 0 to deny (if provider cannot handle multiple threads or so) */
