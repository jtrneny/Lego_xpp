// Alaska Software Xbase++ header constants and function definitions for LL24.DLL
//  (c) combit GmbH
//  [build of 2018-10-02 09:10:41]

// HEADER file to be included in all modules using LL24

#ifndef _LL24_CH // include header only once
#define _LL24_CH
...
#define LL_OPTION_SUPPORT_HUGESTORAGEFS (138)                /* default: true */
...
#define LL_OPTION_IMPROVED_TABLELINEANCHORING (236)                /* default: FALSE */
...
#define LL_OPTION_PRN_FORCE_PROJECTSIZE_AS_PAPERSIZE (336)                /* default: false (true: if "ForcePaperFormat"=TRUE, do not iterate available paper formats and look up a matching one, just put the selected size in the DEVMODE structure and hope for the printer to accept it) */
...
#define LL_REPOSITORYTHREADNESS_QUERY  (2)                  /* default  */
